...
<?php
/*$purl = isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '#';
if (strpos($purl, 'single.php') !== false) {
    //echo 'true';
	echo "<input type='text' name='tme' id='tme'>";
	$time=$_POST['tme'];
	$sql="Insert into track values('$purl','101','$time')";
